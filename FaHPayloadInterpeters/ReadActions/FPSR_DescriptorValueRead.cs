...
{
    public class FPSR_DescriptorValueRead : FAHFunctionPropertyStateResponse
    {
        ...
        {
            moreIndices = false;
            faHDevice.WriteDescriptorValue(this.ObjectID, this.PropertyID,  this.FPSRpayload);
            return true;
        }

        public FPSR_DescriptorValueRead(KNXPayload OwnerPayload) : base(OwnerPayload)
        {
            //Value count is variable
            addIgnoredBytes(5, 25);
        }
    }
}
