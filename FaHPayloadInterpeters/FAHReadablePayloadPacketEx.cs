...
{
    public class FAHReadablePayloadPacketEx : FAHReadablePayloadPacket
    {
        public FAHReadablePayloadPacketEx(KNXPayload kNXPayload) : base(kNXPayload)
        {
        }

        public virtual bool SaveToDevice(ref FaHDevice faHDevice, out bool moreIndices)
        {
            moreIndices = false;
            return false;
        }
